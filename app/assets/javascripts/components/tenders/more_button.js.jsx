var MoreButton = React.createClass({
  ...
  render: function() {
    return (
      <a className='button more-button round ga-tenders' data-gtm-category='' data-gtm-action='more' data-gtm-label={this.props.refNo.replace('/','\\\/')} onClick={this.handleClick}>More</a>
    );
  }
});