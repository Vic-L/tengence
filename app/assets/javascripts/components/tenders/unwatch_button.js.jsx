var UnwatchButton = React.createClass({
  ...
  render: function() {
    ...
    return (
      <a className='button unwatch-button round ga-tenders' data-gtm-category='' data-gtm-action='unwatch' data-gtm-label={this.props.refNo} onClick={this.handleClick}>Unwatch</a>
    );
  }
});