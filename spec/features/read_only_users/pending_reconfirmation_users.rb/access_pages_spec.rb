...
feature "access pages by pending_reconfirmation_users (only test without keywords)" do
  ...
  let(:read_only_pending_reconfirmation_user) {create(:user, :read_only, :unconfirmed, :without_keywords)}
